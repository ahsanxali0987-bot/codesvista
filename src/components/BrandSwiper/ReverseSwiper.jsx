...
export default function ReverseSwiper({ logos } = { logos: null }) {
  const defaultLogos = [
    "toyotalogo.png",
    "fordlogo.png",
    "havallogo.png",
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#0a0e1a] py-6">
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 h-px bg-gradient-to-r from-transparent via-amber-400/60 to-transparent" />
